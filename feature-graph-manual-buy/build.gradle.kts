...
android {
    ...
    namespace = "com.myjar.app.feature_graph_manual_buy"
}
...
dependencies {
    ...
    implementation(project(mapOf("path" to ":feature-post-setup")))
    implementation(project(mapOf("path" to ":shared:feature-post-setup")))
    ...
    implementation(project(":shared:feature-graph-manual-buy"))
