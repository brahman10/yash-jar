...
@Singleton
class CalendarUtil @Inject constructor(private val dispatcherProvider: DispatcherProvider): BaseResources {
    ...
    suspend fun createMonthCalendar(
        monthIndex: Int,
        calenderList: List<FeaturePostSetUpCalendarInfo>
    ): ArrayList<FeaturePostSetUpCalendarInfo> =
        withContext(dispatcherProvider.io) {
            calendar.apply { set(Calendar.MONTH, monthIndex) }
            calendar.set(Calendar.DAY_OF_MONTH, 1)
            val firstDayOfCurrentMonth = calendar.get(Calendar.DAY_OF_WEEK)
            val list = ArrayList<FeaturePostSetUpCalendarInfo>()
    ...
    suspend fun getWeekList(
        ...
        withContext(dispatcherProvider.default) {
            ...
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_sunday), 1
                )
            )
            list.add(
                WeekDayData(
                   getCustomString(context, PostSetupMR.strings.feature_post_setup_monday), 2
                )
            )
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_tuesday), 3
                )
            )
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_wednesday), 4
                )
            )
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_thursday), 5
                )
            )
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_friday), 6
                )
            )
            list.add(
                WeekDayData(
                    getCustomString(context, PostSetupMR.strings.feature_post_setup_saturday), 7
                )
            )
            return@withContext list
        }
    ...
    fun getWeekFromDay(
        ...
        val context = contextRef.get()!!
        return when (day) {
            1 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_sunday)
            2 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_monday)
            3 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_tuesday)
            4 -> getCustomString(context,PostSetupMR.strings.feature_post_setup_wednesday)
            5 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_thursday)
            6 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_friday)
            7 -> getCustomString(context, PostSetupMR.strings.feature_post_setup_saturday)
            else -> {
                getCustomString(context, PostSetupMR.strings.feature_post_setup_sunday)
            }
        }
    }
    ...
    enum class DsCancellationVersion{
        V3
    }
}