...
@Composable
internal fun RenderStopDailySavingStaticBottomSheet(
            ...
            Column {
                    ...
                    modifier = Modifier
                        ...
                        .debounceClickable(onClick = {
                            analyticsHandler.postEvent(
                                ...
                                mapOf(
                                    DailyInvestmentCancellationEventKey.Button_type to DailyInvestmentStatusScreen.Close,
                                    DailyInvestmentStopKey.type to DailyInvestmentStatusScreen.Statistic
                                )
                            )
                ...
                Text(
                    ...
                    text = generateSpannedFromHtmlString(
                        stopDailySavingBottomSheetDetails.statisticsContent?.title.orEmpty(),
                        true
                    ).toAnnotatedString(),
                    fontFamily = jarFontFamily,
                    lineHeight = 30.sp,
                ...
                Column(
                    ...
                    LazyColumn {
                        ...
                        item {
                            RatingCard(
                                stopDailySavingBottomSheetDetails.statisticsContent?.rating.orEmpty(),
                                stopDailySavingBottomSheetDetails.statisticsContent?.downloads.orEmpty()
                            )
