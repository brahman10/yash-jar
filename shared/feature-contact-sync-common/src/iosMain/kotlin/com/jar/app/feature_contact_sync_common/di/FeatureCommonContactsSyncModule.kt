package com.jar.app.feature_contact_sync_common.di
...
class FeatureCommonContactsSyncModule(
    client: HttpClient
) {

    private val dataSource: ContactsSyncDataSource by lazy {
        ContactsSyncDataSource(client)
    }

    private val contactsSyncRepository: IContactsSyncRepository by lazy {
