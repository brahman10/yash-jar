...
interface FetchDigiLockerRedirectionUrlUseCase {

    suspend fun fetchDigiLockerRedirectionUrl(
        kycFeatureFlowType: KycFeatureFlowType,
        shouldEnablePinless: Boolean = false
    ): Flow<RestClientResult<ApiResponseWrapper<DigiLockerRedirectionUrlData?>>>
