...
data class GetCardInfoPayload(
    ...
    fun toJsonObject(): JsonObject {
        ...
        val innerPayload = JsonObject(
            mapOf(
                "action" to OneTimePaymentConstants.JuspayAction.CARD_INFO.toJsonElement(),
                "cardBin" to cardBin.toJsonElement(),
    ...
    fun toMap(): Map<String, Any> {
        val innerPayload = mapOf(
            "action" to OneTimePaymentConstants.JuspayAction.CARD_INFO,
            "cardBin" to cardBin,
