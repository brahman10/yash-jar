...
import com.jar.app.databinding.FragmentOnboardingStoryVariant1Binding
...
@AndroidEntryPoint
internal class OnBoardingStoryFragmentVariant1 : BaseFragment<FragmentOnboardingStoryVariant1Binding>() {
    ...
    private var storyAdapter: OnboardingStoriesV1Adapter? = null
    ...
    companion object {
        ...
        fun getInstance(onboardingStoryData: OnboardingStoryData): Fragment {
            val fragment = OnBoardingStoryFragmentVariant1()
            val bundle = bundleOf()
    ...
    override val customBindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentOnboardingStoryVariant1Binding
        get() = FragmentOnboardingStoryVariant1Binding::inflate
    ...
    private fun setupUI() {
        storyAdapter = OnboardingStoriesV1Adapter(
    ...
    private fun toggleUI(position: Int) {
        ...
        if (position == onBoardingStories?.size.orZero() - 1) {
            ...
            binding.btnNext.setCustomButtonStyle(com.jar.app.core_ui.widget.button.ButtonType.primaryButton)
            binding.btnNext.setDrawableEnd(0)
            analyticsHandler.postEvent(
                EventKey.Shown_startnowcta_Onboardingstories,
                mapOf(
                    EventKey.variants to storyType.orEmpty()
                ),
