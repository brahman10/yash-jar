...
android {
    ...
    namespace = "com.jar.app.feature_refer_earn_v2"
}
...
//    implementation("com.amulyakhare:com.amulyakhare.textdrawable:1.0.1")
    ...
    implementation("com.google.accompanist:accompanist-flowlayout:${Dependencies.Android.compose_flowlayout}")

    implementation ("com.airbnb.android:lottie-compose:${Dependencies.Android.compose_lottie}")


    implementation("androidx.paging:paging-runtime:${Dependencies.Android.compose_paging}")

    // alternatively - without Android dependencies for tests
    testImplementation("androidx.paging:paging-common:${Dependencies.Android.compose_paging}")

    // optional - RxJava2 support
    implementation("androidx.paging:paging-rxjava2:${Dependencies.Android.compose_paging}")

    // optional - RxJava3 support
    implementation("androidx.paging:paging-rxjava3:${Dependencies.Android.compose_paging}")

    implementation("androidx.paging:paging-compose:${Dependencies.Android.compose_paging}")
