...
class DotIndicatorDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    private val selectedColor: Int = ContextCompat.getColor(context,com.jar.app.core_ui.R.color.white)
    private val unselectedColor: Int = ContextCompat.getColor(context, com.jar.app.core_ui.R.color.color_776e94)
    ...
    override fun onDrawOver(
        ...
        parent.adapter?.takeIf { it.itemCount > 0 }?.run {
            val itemCount = (this as RecyclerView.Adapter).itemCount
