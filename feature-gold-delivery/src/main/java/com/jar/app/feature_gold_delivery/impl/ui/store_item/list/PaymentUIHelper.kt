...
internal object PaymentUIHelper {
    ...
    fun setIconStatus(status: com.jar.app.feature_one_time_payments_common.shared.ManualPaymentStatus, view: WeakReference<AppCompatImageView>) {
    ...
    fun setPillStatus(status: com.jar.app.feature_one_time_payments_common.shared.ManualPaymentStatus, view: WeakReference<AppCompatTextView>) {
