...
import com.jar.app.base.util.BaseExtensionsKt;
...
public class CropView extends FrameLayout implements CropAreaView.AreaViewListener, CropGestureDetector.CropGestureListener {
    ...
    private static final float HAND_ANIMATION_FACTOR = 200f;

    private final View backView;

    private final CropAreaView areaView;
    ...
    //    private View toolTipView = null;
    private final int backgroundColor;
    private final Integer[][] ratios = new Integer[][]{
            new Integer[]{3, 2},
            new Integer[]{4, 10},
            new Integer[]{4, 3},
            new Integer[]{5, 4},
    ...
    private AspectRatioChangeListener aspectRatioListener;
    private CropBoxMovedListener cropBoxMovedListener;
    ...
    public CropView(Context context) {
        ...
        animating = false;
        backgroundColor = ContextCompat.getColor(context, com.jar.app.core_ui.R.color.bgColor);
        backView = new View(context);
        backView.setBackgroundColor(backgroundColor);//0xff000000
    ...
    public void setAspectRatio(float ratio) {
        ...
        areaView.calculateRect(targetRect, ratio);
    ...
    private void fillAreaView(RectF targetRect, boolean allowZoomOut) {
        ...
        float statusBarHeight = (Build.VERSION.SDK_INT >= 21 ? BaseExtensionsKt.getDp(56) : 0);
    ...
    public void onAreaChange() {
        ...
        fitContentInBounds(false, false, false);
    }
    ...
    public void onAreaChangeEnded() {
        ...
        if (cropBoxMovedListener != null)
            cropBoxMovedListener.onCropBoxMoved();
    }
    ...
    public void setInitialAspectRatio(boolean isSelectedFromGallery) {
        Integer[] ratioPair = new Integer[]{3, 7};
        boolean aspectIsGreaterThanOne = areaView.getAspectRatio() > 1.0f;
        if (isSelectedFromGallery && aspectIsGreaterThanOne) return;
        if (aspectIsGreaterThanOne) {
            setAspectRatio(ratioPair[0] / (float) ratioPair[1]);
        } else {
            setAspectRatio(ratioPair[1] / (float) ratioPair[0]);
        }
    }
    ...
    public void showAspectRatioDialog() {
        ...
        actions[0] = "CropOriginal";
        actions[1] = "CropSquare";
                    ...
                    switch (which) {
                        case 0: {
                            ...
                            if (aspectRatioListener != null) {
                                aspectRatioListener.onAspectRatioChanged(w / h);
                            }
                        ...
                        case 1: {
                            if (aspectRatioListener != null) {
                                aspectRatioListener.onAspectRatioChanged(1.0f);
                            }
                        ...
                        default: {
                            ...
                            if (areaView.getAspectRatio() > 1.0f) {
                                ...
                                if (aspectRatioListener != null) {
                                    aspectRatioListener.onAspectRatioChanged(ratioPair[0] / (float) ratioPair[1]);
                                }
                            } else {
                                setLockedAspectRatio(ratioPair[1] / (float) ratioPair[0]);

                                if (aspectRatioListener != null) {
                                    aspectRatioListener.onAspectRatioChanged(ratioPair[1] / (float) ratioPair[0]);
                                }
                            }
                        }
                        break;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL: {
                if (zoomChangeListener != null) {
                    zoomChangeListener.onZoomChanged(lastScale, state.scale);
                }
                lastScale = state.scale;
                onScrollChangeEnded();
                break;
    ...
    public void setAspectRatioListener(AspectRatioChangeListener aspectRatioListener) {
    ...
    public void setCropBoxMovedListener(CropBoxMovedListener cropBoxMovedListener) {
        this.cropBoxMovedListener = cropBoxMovedListener;
    }
    ...
    public interface ZoomChangeListener {
        void onZoomChanged(Float oldScale, Float newScale);
    }
    ...
    public interface CropBoxMovedListener {
        void onCropBoxMoved();
    }
