...
import com.jar.app.feature_homepage.databinding.FeatureHomepageCellTypeOneBinding
import kotlinx.coroutines.*
import java.lang.ref.WeakReference

internal class TypeOneEpoxyModel(
...
) : CustomViewBindingEpoxyModel<FeatureHomepageCellTypeOneBinding>(R.layout.feature_homepage_cell_type_one),
    HorizontalCard {
    ...
    override fun getBinding(view: View): FeatureHomepageCellTypeOneBinding {
        return FeatureHomepageCellTypeOneBinding.bind(view)
    }

    override fun bindItem(binding: FeatureHomepageCellTypeOneBinding) {
