...
import com.jar.app.feature_homepage.databinding.FeatureHomepageCellTypeThreeBinding
import com.jar.app.core_ui.dynamic_cards.model.HomeFeedCard
import kotlinx.coroutines.*
import java.lang.ref.WeakReference

internal class TypeThreeEpoxyModel(
    ...
    CustomViewBindingEpoxyModel<FeatureHomepageCellTypeThreeBinding>(R.layout.feature_homepage_cell_type_three) {
    ...
    override fun getBinding(view: View): FeatureHomepageCellTypeThreeBinding {
        return FeatureHomepageCellTypeThreeBinding.bind(view)
    }

    override fun bindItem(binding: FeatureHomepageCellTypeThreeBinding) {
