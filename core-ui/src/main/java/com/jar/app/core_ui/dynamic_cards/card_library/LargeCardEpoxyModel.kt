...
import com.jar.app.core_ui.databinding.DynamicCardsCellLargeCardBinding
...
class LargeCardEpoxyModel(
    ...
    CustomViewBindingEpoxyModel<DynamicCardsCellLargeCardBinding>(R.layout.dynamic_cards_cell_large_card) {
    ...
    override fun bindItem(binding: DynamicCardsCellLargeCardBinding) {
        this@LargeCardEpoxyModel.shimmerLayout = binding.shimmerLayout
        ...
        background.cornerRadius =
            libraryCardViewData.cardMeta?.cardBackground?.getCornerRadius()?.dp.orZero()
        ...
        libraryCardViewData.cardMeta?.cta?.icon?.let {
            ...
            binding.btnAction.clearCompoundDrawablesRelativeWithIntrinsicBounds()
        }
    ...
    override fun getBinding(view: View): DynamicCardsCellLargeCardBinding {
        return DynamicCardsCellLargeCardBinding.bind(view)
    }
}