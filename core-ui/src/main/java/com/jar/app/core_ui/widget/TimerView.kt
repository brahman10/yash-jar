...
import com.jar.app.base.util.secondsToCountDown
import com.jar.app.core_ui.R
import com.jar.app.core_ui.databinding.CoreUiTimerViewBinding
...
class TimerView @JvmOverloads constructor(
    ...
    private var binding: CoreUiTimerViewBinding

    private var countDownJob: Job? = null

    init {
        binding = CoreUiTimerViewBinding.inflate(LayoutInflater.from(context), this, true)
        renderView()
    }
