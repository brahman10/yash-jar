...
import com.jar.app.core_ui.util.BaseResourcesViewHolderExtension

open class BaseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), BaseResourcesViewHolderExtension {
